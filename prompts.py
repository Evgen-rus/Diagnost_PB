...
Спрашивайте о любых темах, связанных с неразрушающим контролем!"""

# Добавляем константу для промпта первого вопроса
FIRST_QUESTION_PROMPT = "НЕ используй приветствия (такие как 'Привет', 'Здравствуйте' и т.д.). Задай только один простой вопрос - какая тема в области неразрушающего контроля интересует пользователя. Не спрашивай про уровень знаний - определяй его по контексту последующих сообщений."
